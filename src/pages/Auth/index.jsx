      ...
      >
        ...
        <div className="bg-white rounded-3xl border border-stone-100 shadow-sm p-8">
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-stone-200 rounded-xl text-stone-700 text-sm font-medium hover:bg-stone-50 transition-colors mb-6 disabled:opacity-50"
          >
        ...
        <p className="text-center text-sm text-stone-500 mt-6">
          {mode === 'login' ? (
            <>
              Ainda não tem conta?{' '}
              <button onClick={() => setMode('register')} className="text-stone-900 font-medium hover:underline">
                Criar conta grátis
              </button>
            </>
          ) : (
            <>
              Já tem conta?{' '}
              <button onClick={() => setMode('login')} className="text-stone-900 font-medium hover:underline">
                Entrar
              </button>
            </>
          )}
